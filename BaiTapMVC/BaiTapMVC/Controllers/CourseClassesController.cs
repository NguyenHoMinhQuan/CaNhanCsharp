...
namespace BaiTapMVC.Controllers
{
    public class CourseClassesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseClassId,CourseId,TeacherId")] CourseClass courseClass)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Courses, "CourseId", "CourseName", courseClass.CourseId);
            ViewData["TeacherId"] = new SelectList(_context.Teachers, "TeacherId", "Name", courseClass.TeacherId);
            return View(courseClass);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseClassId,CourseId,TeacherId")] CourseClass courseClass)
        {
